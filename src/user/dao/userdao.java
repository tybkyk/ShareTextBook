...
public class userdao {
	...
	public void insertUser(userinfo user) {
        ...
        try {
            ...
            String sql = "INSERT INTO user1 (user_name,user_password,user_aurtority)VALUES ('"+ user.getUserName()+ "','"+ user.getUserPassword() + "','"+user.getUserAurtority()+ "')";
...
//may be have some logic problem     
        try {
        	 ...
        	 if (userName.equals(null)) {
 	            ...
 	            rs = stmt.executeQuery("select user_password from user1 where user_name='" + userName + "'");
 	            if (rs.next()) {
